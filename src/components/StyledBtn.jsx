...
export default function StyledBtn({ title }) {
  return (
    <button
      type="submit"
      className="flex gap-5 items-center justify-between border-4 border-[#e984de]  bg-black text-white px-6 py-2 rounded-tl-xl rounded-br-xl hover:bg-black transition-all duration-300 ease-in-out w-full"
    >
