  ...
  return (
    <>
      ...
      <div className="md:w-[60%] w-[90%]">
        ...
        <div className="bg-gradient-to-r from-violet-50 to-indigo-50 rounded-2xl p-6 mb-8 border border-indigo-100/50 relative overflow-hidden group mt-11">
          ...
          <div className="text-center relative">
            ...
            <p className="text-gray-600 mt-3 font-medium">For your amazing service</p>
          </div>
        </div>
      <div className="flex justify-center items-center mt-11">
      <button onClick={() => createRazorpayOrder(100)} className="md:w-[60%] w-[100%] group relative overflow-hidden px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl text-white font-semibold shadow-lg transition-all duration-300 transform hover:scale-105 hover:shadow-xl active:scale-95 flex justify-center items-center">
      <FaLock /><pre> </pre>Pay Now
      ...
      <div className="md:flex md:items-center gap-2 text-gray-600 md:justify-evenly flex justify-center mt-7 w-[100%] md:ps-[22%] ps-0">
        <span className="text-sm flex items-center w-[60%]  text-gray-600 bg-gray-50/80 p-3 rounded-xl transition-colors duration-300 hover:bg-gray-100/80"><IoIosLock /><pre> </pre>Secure Payment</span>
      ...
      <div className="mt-11 text-[15px] md:block hidden indent-4 text-gray-500">Experience premium service with our comprehensive package. Your payment includes full access to all premium features, priority support, and exclusive content. Satisfaction guaranteed.</div>
      ...
      <div className="md:mt-5 flex justify-center mt-6 text-gray-500">© 2025 Marriage Vendors. All rights reserved.</div>
    </div>
    </div>
      </div>
    </>
