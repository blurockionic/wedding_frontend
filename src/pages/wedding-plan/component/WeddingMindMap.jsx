...
const WeddingMindMap = ({ data, handleOnAddSubEvent, handleOnAddTask, handleOnAddVendor}) => {
        ...
        >
          ...
          <div className="right-4 top-4 relative">
            ...
            {isActiveActions && index === activeIndex && (
             <div className={`absolute z-40 right-0 mt-2 w-48 bg-white p-4 rounded-md shadow-md transition-all duration-300 
              ${isActiveActions && index === activeIndex ? "opacity-100 scale-100" : "opacity-0 scale-95 pointer-events-none"}`}>            
