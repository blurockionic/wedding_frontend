...
const WeddingEventList = ({
  ...
  const {
    ...
    refetch,
  } = useGetEventTasksQuery(currentEventId, { skip: !currentEventId });
  ...
  return (
    <section className="p-2 sm:p-4 bg-gray-50 rounded-lg">
        ...
        >
          ...
          {isToggle && index === toggledIndex && (
            <div className="p-3 sm:p-5">
                  ...
                  {editingIndexes[`${index}-eventDescription`] ? (
                    <div className="flex items-center">
                      ...
                      <button
                        className="ml-2 p-1 bg-green-500 text-white rounded-md hover:bg-green-600"
                        onClick={() =>
                          handleSaveChanges(index, "eventDescription")
                        }
                      >
                        {isUpdating ? (
                          <Loader2 className="animate-spin" size={16} />
                    ...
                    {editingIndexes[`${index}-eventStartTime`] ? (
                      <div className="flex items-center">
                        ...
                        <button
                          className="ml-2 p-1 bg-green-500 text-white rounded-md hover:bg-green-600"
                          onClick={() =>
                            handleSaveChanges(index, "eventStartTime")
                          }
                        >
                          {isUpdating ? (
                            <Loader2 className="animate-spin" size={16} />
                    ...
                    {editingIndexes[`${index}-eventEndTime`] ? (
                      <div className="flex items-center">
                        ...
                        <button
                          className="ml-2 p-1 bg-green-500 text-white rounded-md hover:bg-green-600"
                          onClick={() =>
                            handleSaveChanges(index, "eventEndTime")
                          }
                        >
                          {isUpdating ? (
                            <Loader2 className="animate-spin" size={16} />
              ...
              {/* Task Section */}
              <div className="bg-yellow-50 p-3 sm:p-5 rounded-lg border border-yellow-100 mb-6">
              ...
              {/* Services Section */}
              <div className="bg-blue-50 p-3 sm:p-5 rounded-lg border border-blue-100">
